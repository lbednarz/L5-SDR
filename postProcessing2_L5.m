...
addpath C:\Users\Sahil\Desktop\Sterenn\Matlab\SDR\include             % The software receiver functions
addpath C:\Users\Sahil\Desktop\Sterenn\Matlab\SDR\geoFunctions        % Position calculation related functions
...
%% Acquisition ============================================================
    ...
    if ((settings.skipAcquisition == 0) || ~exist('acqResults', 'var'))
        ...
        %--- Do the acquisition -------------------------------------------
%         disp('    Acquisition NH code...');
%         acqNHcode = acquisitionL5Q_NH(data,settings);
        
        disp ('   Acquiring satellites...');
        acqResultsL5 = acquisitionL5Q(data, settings);
%         acqResultsL5 = acquisitionL5I(data, settings);
%         acqResultsL5 = acquisitionL5IQ(data, settings);
        plotAcquisition(acqResultsL5);
        
%         acqResultsL5I = acquisition_two_signals_L5(data, settings, 'I');
%         acqResultsL5Q = acquisition_two_signals_L5(data, settings, 'Q');
%         acqResultsL5IQ = acquisition_two_signals_L5(data, settings, 'IQ');
%         plotAcquisition(acqResultsL5I);
%         plotAcquisition(acqResultsL5Q);
%         plotAcquisition(acqResultsL5IQ);
...
%% Initialize channels and prepare for the run ============================
    ...
    if (any(acqResultsL5.carrFreq))
        channel = preRun(acqResultsL5, settings);
...
%     [trackResultsL5, channel] = trackingL5(fid, channel, settings);
    [trackResultsL5, channel] = trackingL5(fid, channel, settings);
    ...
    save('trackingResultsL5', ...
                      'trackResultsL5', 'settings', 'acqResultsL5', 'channel');
                  
% %% Calculate navigation solutions =========================================
%     disp('   Calculating navigation solutions...');
%     navSolutions = postNavigation(trackResultsL5, settings);
% 
...
%% Plot all results =======================================================
    ...
    if settings.plotTracking
        plotTracking(1:settings.numberOfChannels, trackResultsL5, settings);
    end
