...
title (hAxes, 'Acquisition results', 'FontSize',25);
xlabel(hAxes, 'PRN number (no bar - SV is not in the acquisition list)', 'FontSize',20);
ylabel(hAxes, 'Acquisition Metric', 'FontSize',20);
