function acqResults = acquisitionL5IQ(longSignal, settings)
...
%         IQfreqDom22 = fft(I22 + j*Q22);
        ...
        %domain)
        convCodeIQ1 = IQfreqDom1 .* L5ICodeFreqDom;
        convCodeIQ2 = IQfreqDom2 .* L5ICodeFreqDom;
...
%         p2 = unwrap(p2,[],2);
        ...
        acqRes21 = abs(ifft(convCodeIQ2)) .^ 2;
